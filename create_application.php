...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO Applications (category_id, posted_date, author, title, review, image, image_dir, status, created, modified) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())");
    $stmt->bind_param("isssssss", $category_id, $posted_date, $author, $title, $review, $image_dir, $image_dir, $status);
...
<head>
    ...
    <title>MobRevApp - App Reviewer Creator</title>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
            <form action="create_application.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="review" id="review" rows="5" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Upload image for the review.</p>
                </div>
