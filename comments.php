...
<head>
    ...
    <title>MobRevApp - Comments Manager</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                ...
                <a href="categories.php" class="text-white hover:gray-blue-200">Categories</a>
                <a href="comments.php" class="text-white hover:text-gray-200">Comments</a>
                <a href="create_application.php" class="bg-green-700 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">Add New Review</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto p-4">
        ...
        <?php if (empty($comments)): ?>
            <p class="text-center text-gray-600 text-xl mt-10"> Not found comment. </p>
        <?php else: ?>
