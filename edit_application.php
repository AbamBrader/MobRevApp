...
<head>
    ...
    <title>MobRevApp - App Review Editor</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold mb-6 text-center text-gray-800">Edit Review App</h1>
        ...
        <?php if ($app): ?>
            <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
                <form action="edit_application.php?id=<?php echo htmlspecialchars($app['id']); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="title" class="block text-gray-700 text-sm font-bold mb-2">App Title :</label>
